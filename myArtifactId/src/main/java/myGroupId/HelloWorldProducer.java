 ...
 */
public class HelloWorldProducer extends AbstractApiProducer<HelloWorldApiName, HelloWorldConfiguration>  {
    ...
    public HelloWorldProducer(HelloWorldEndpoint endpoint) {
        super(endpoint, HelloWorldPropertiesHelper.getHelper());
    }
 ...
 //   }
    ...
    protected Object doInvokeMethod(ApiMethod method, Map<String, Object> properties) throws RuntimeCamelException {
        AbstractHelloWorldRequest request = (AbstractHelloWorldRequest) super.doInvokeMethod(method, properties);
        try {
